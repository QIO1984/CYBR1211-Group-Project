...
4. Structures
5. Menus
In this project, you will work in teams of 2-3 students to use C++ to develop a library management program that maintains the library book list. The goal is to ensure that all team members participate and share the load of the work and produce a working program.
...
2. You will upload this file to Blackboard.
3. Also, upload a presentation of your program. 
    ...
    b. The presentation should be 10-12 minutes in length. 
4. This is a chance to do the following:
