...
- I have "found" a sample project for reference. It essentially works as expected.
...
- The sample code is only to provide a rough reference for the code we will create.

## Teamwork
- Visit the TeamFiles folder and check out the readme.md!
